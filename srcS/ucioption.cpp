...
void init(OptionsMap& o) {
  ...
  o["Material(MG)"]          << Option(100, 0, 200, on_eval);
  o["Material(EG)"]          << Option(100, 0, 200, on_eval);
  o["Imbalance(MG)"]         << Option(100, 0, 200, on_eval);
  o["Imbalance(EG)"]         << Option(100, 0, 200, on_eval);
  o["PawnStructure(MG)"]     << Option(100, 0, 200, on_eval);
  o["PawnStructure(EG)"]     << Option(100, 0, 200, on_eval);
  o["Mobility(MG)"]          << Option(100, 0, 200, on_eval);
  o["Mobility(EG)"]          << Option(100, 0, 200, on_eval);
  o["PassedPawns(MG)"]       << Option(100, 0, 200, on_eval);
  o["PassedPawns(EG)"]       << Option(100, 0, 200, on_eval);
  o["KingSafety(MG)"]        << Option(100, 0, 200, on_eval);
  o["KingSafety(EG)"]        << Option(100, 0, 200, on_eval);
  o["Threats(MG)"]           << Option(100, 0, 200, on_eval);
  o["Threats(EG)"]           << Option(100, 0, 200, on_eval);
