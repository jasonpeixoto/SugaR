...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-40,-51), S(-12,-24), S(-23,-30), S(-31,-12) },
   { S(-18,-27), S(18,-2), S(11,-7), S(1,11) },
   { S(-8,-16), S(24,7), S(19,4), S(10,23) },
   { S(-10,-19), S(25,4), S(19,2), S(9,23) },
   { S(-10,-19), S(21,3), S(14,0), S(8,21) },
   { S(-16,-17), S(14,5), S(11,7), S(2,20) },
   { S(-21,-27), S(15,-3), S(5,-5), S(-2,13) },
   { S(-32,-48), S(-10,-25), S(-17,-29), S(-26,-10) }
  },
  { // Rook
